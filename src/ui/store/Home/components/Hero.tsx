...
export default function Hero() {
    return (
        <section className='langingpage-container mt-24 md:mt-12 flex flex-col md:flex-row items-center justify-between gap-8 text-start px-4 py-8 lg:px-8 lg:py-8 '>
            ...
            <div className='w-full flex-1 rounded-3xl overflow-hidden ring-4 ring-primary/50 ring-offset-2'>
                <Image
                    src={heroImg}
                    alt='hero image'
                    width={2000}
